...
HTMLNavigationForm.prototype.setMainImages = function(imgInclude, imgEdit, imgFirst,
  ...
  if (this.isEditable) {
    ...
    this.btDesignSave = this.addDesignButton('fas fa-save', '', getLocaleMessage('LABEL.SAVE_RECORD_MORE') + ' (Ctrl+G)', this.getAction('actDesignSave'), true, this.iconsSize, '');
  }
...
HTMLNavigationForm.prototype.setIncludeImages = function(imgSave, imgCancel, imgSaveMore) {
  if (imgSaveMore != -1) this.btIncludeSaveMore = this.addIncludeButton('fas fa-save', getLocaleMessage("LABEL.SAVE_RECORD_MORE") + ' +', getLocaleMessage("LABEL.SAVE_RECORD_MORE") + ' (Ctrl+G)', this.getAction('actIncludeSaveMore'), true, this.iconsSize, 'IncludeSaveMore');
