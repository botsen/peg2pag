	  ...
	  _createClass(_class, [{
	    ...
	    value: function init() {
	      ...
	      if (this.options.pagination && this.options.sidePagination === 'server' && this.options.addrbar) {
	        ...
	        var _prefix = this.options.addrPrefix || ''; // ä¼?å??çº§æ??åº?: ç?¨æ?·æ??å®?å?¼æ??ä¼?å??, æ?ªæ??å®?æ?¶ä»?å?°å??æ ?è?·å??, æ?ªè?·å??å?°æ?¶é??ç?¨é»?è®¤å?¼
	        ...
	        this.options.onLoadSuccess = function (data) {
	          if (_this.addrbarInit) {
	            ...
	            var params = {};
	            params["".concat(_prefix, "page")] = _this.options.pageNumber, params["".concat(_prefix, "size")] = _this.options.pageSize, params["".concat(_prefix, "order")] = _this.options.sortOrder, params["".concat(_prefix, "sort")] = _this.options.sortName, params["".concat(_prefix, "search")] = _this.options.searchText; // h5æ??ä¾?ç??ä¿®æ?¹æµ?è§?å?¨å?°å??æ ?ç??æ?¹æ³?
