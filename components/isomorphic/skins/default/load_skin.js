/*============================================================
    "Default" theme programmatic settings
...
//----------------------------------------
    ...
    // -----------------------------------------------------   
    // css3 and spriting are required for the Default skin
    var useCSS3 = isc.Browser.useCSS3,
        useSpriting = isc.Browser.useSpriting;
        
    if (!useCSS3 || !useSpriting) {
        isc.logWarn("Default skin makes use of HTML5 features which may be " +
    ...
    if (isc.CheckboxItem) {
        ...
        isc.CheckboxItem.addProperties({
            ...
            // For Default there is no default "unset" image
    ...
    if (isc.setCurrentSkin) isc.setCurrentSkin("Default", "Flat");
